...
export function Post({author, content, publishedAt}: PostProps) {
    ...
    const publishedAtDateRelativeNow = formatDistanceToNow(publishedAt, {
        locale: ptBR,
        addSuffix: true
    })
    ...
    function handleNewCommentInvalid(event: InvalidEvent<HTMLTextAreaElement>) {
        event.target.setCustomValidity("O campo comentário é obrigatório")
    }
